...
var floorTile, wallTile, tableTile *pixel.Sprite
...
func run() {
	...
	wallTile = pixel.NewSprite(pic, pixel.R(0, 448, 64, 512))
	floorTile = pixel.NewSprite(pic, pixel.R(0, 128, 64, 192))
	tableTile = pixel.NewSprite(pic, pixel.R(64*3, 128, 64*2, 192))
	depthSort()
